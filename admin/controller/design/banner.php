...
class ControllerDesignBanner extends Controller {
	...
	private function getForm() {
		...
		foreach ($banner_images as $banner_image) {
            ...
            if ($banner_image['mobile_image'] && file_exists(DIR_IMAGE . $banner_image['mobile_image'])) {
                $mobile_image = $banner_image['mobile_image'];
            } else {
                $mobile_image = 'no_image.jpg';
            }
            ...
            $this->data['banner_images'][] = array(
                ...
                'mobile_thumb'             => $this->model_tool_image->resize($mobile_image, 100, 100),
			);	
		} 
