        ...
        <table id="images" class="list">
          <thead>
            <tr>
              ...
              <td class="left">Для мобильной версии</td>
              <td class="left">Порядок сортировки</td>
          ...
          <tbody id="image-row<?php echo $image_row; ?>">
            <tr>
              ...
              <td class="left"><div class="image"><img src="<?php echo $banner_image['mobile_thumb']; ?>" alt="" id="mobile_thumb<?php echo $image_row; ?>" />
                  <input type="hidden" name="banner_image[<?php echo $image_row; ?>][mobile_image]" value="<?php echo $banner_image['mobile_image']; ?>" id="mobile_image<?php echo $image_row; ?>"  />
                  <br />
                  <a onclick="image_upload('mobile_image<?php echo $image_row; ?>', 'mobile_thumb<?php echo $image_row; ?>');"><?php echo $text_browse; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$('#mobile_thumb<?php echo $image_row; ?>').attr('src', '<?php echo $no_image; ?>'); $('#mobile_image<?php echo $image_row; ?>').attr('value', '');"><?php echo $text_clear; ?></a></div>
              </td>
              <td class="left"><input type="text" name="sort_order" value="<?php echo $sort_order; ?>" /></td>
...
function addImage() {
	...
	html += '<td class="left"><input type="text" name="sort_order" value="0" /></td>';
