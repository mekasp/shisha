...
<div style="width: 100%; display: inline-block;">
  <div style="float: left; width: 569px;">
    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      <p>1 . Пожалуйста заполните информацию о базе данных.</p>
      <div style="background: #F7F7F7; border: 1px solid #DDDDDD; padding: 10px; margin-bottom: 15px;">
        <table>
          <tr>
            <td width="185"><span class="required">*</span>Хост базы данных:</td>
      ...
      <p>2. Пожалуйста заполните имя пользователя и пароль администратора.</p>
      <div style="background: #F7F7F7; border: 1px solid #DDDDDD; padding: 10px; margin-bottom: 15px;">
        <table>
          <tr>
            <td width="185"><span class="required">*</span>Имя пользователя:</td>
